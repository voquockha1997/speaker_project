...
{
    return create<spdlog::sinks::rotating_file_sink_mt>(logger_name, filename, SPDLOG_FILENAME_T("log"), max_file_size, max_files, force_flush);
}
...
{
    return create<spdlog::sinks::rotating_file_sink_st>(logger_name, filename, SPDLOG_FILENAME_T("log"), max_file_size, max_files, force_flush);
}
...
{
    return create<spdlog::sinks::daily_file_sink_mt>(logger_name, filename, SPDLOG_FILENAME_T("log"), hour, minute, force_flush);
}
...
{
    return create<spdlog::sinks::daily_file_sink_st>(logger_name, filename, SPDLOG_FILENAME_T("log"), hour, minute, force_flush);
}
